...
WEEKLY_INPUT <- "./Weekly_Modelling/Input/This_Week.csv"
HISTORICAL_INPUT <- "./Weekly_Modelling/Input/PGA.xlsx"
WEEKLY_OUTPUT <- "./Weekly_Modelling/Input/This_Week_Processed1.xlsx"
HISTORICAL_OUTPUT <- "./Weekly_Modelling/Input/PGA_Processed1.xlsx"
...
# ===== EXECUTION =====
# Process both datasets automatically
cat("=== UNIFIED GOLF DATA PREPROCESSING ===\n")
