...
proj.list <- list()
selected_indices <- sample(1:length(pgalist_filtered), 20)
...
# Models
keepLayers <- c("yr3_Tour", "Top20_Odds", "compat2", "current_rank", "compat_rank", "Top5_rank", "sgp", "diff_from_min", "sgtee", "course_rank", "sgatg", "location", "Starts_HomeShare", "sgapp")
keepLayers <- c("Top40_Odds", "current_rank", "yr3_Tour", "compat_rank", "sgtee", "location_rank", "course_rank", "sgapp", "X_Top5", "current_top20", "location_top20", "sgt2g_top20", "sgapp_top20", "active_2wks", "sgp_top5", "course_top5")
keepLayers <- c("yr3_Tour","Top20_Odds","current_rank","compat2","compat_rank") # Run 3_EQ70-71
keepLayers <- c("yr3_Tour", "Top20_Odds", "current_rank", "compat2", "compat_rank", "diff_from_min", "location", "course_rank", "sgtee", "location_rank", "sgapp", "Starts_HomeShare", "sgp_rank", "sgatg_rank") # Run 4_EQ70-71
keepLayers <- c("current_rank", "Top20_Odds", "yr3_Tour", "compat_rank", "X_Top5", "compat2", "course_rank", "current_top20", "sgapp_top20", "sgt2g_top20", "Starts_HomeShare", "sgtee", "field", "location_top20", "sgp_top20", "sgatg_top20", "active_2wks", "course_top20", "rating_median", "sgp_top5", "course_events", "lastweek", "Quality", "sgp_rank") # Run 4_EQ70-71
...
run  <-   "5_EQ70-71" # CHANGE THE RUN NUMBER
