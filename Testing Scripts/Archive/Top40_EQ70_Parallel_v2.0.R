...
# Define model variables (from Script 2)
                         ...
                         .verbose = FALSE) %dopar% {
                           ...
                           tryCatch({
                             ...
                             result_data <- data.frame(
                               ...
                               actual_top40 = predictions$top_40,
                               actual_position = predictions$posn,
                               top40_odds = predictions$Top40_Odds,
                               top40_winnings = predictions$top40_winnings,
...
if (nrow(successful_predictions) > 0) {
  ...
  top40_rate <- round(sum(successful_predictions$actual_top40) / nrow(successful_predictions) * 100, 1)
