...
df <- df %>%
  ...
  filter(Quality>= 70 & Quality<= 70.5)
...
# Models
keepLayers <- c("yr3_Tour", "Top20_Odds", "current_rank", "compat2", "compat_rank", "diff_from_min", "location", "course_rank", "sgtee", "location_rank", "sgapp", "Starts_HomeShare", "sgp_rank") # Run 1_EQ70-70.5      
keepLayers <- c("yr3_Tour", "Top20_Odds", "current_rank", "compat2", "compat_rank", "location_rank", "course_rank", "diff_from_min", "sgtee", "sgp", "sgapp", "sgatg_rank", "Starts_HomeShare", "X_Top5", "rating_mean", "rating_median", "Quality", "field") # Run 2_EQ70-70.5 
keepLayers <- c("yr3_Tour", "Top20_Odds", "current_rank", "compat2", "compat_rank", "location_rank", "course_rank", "diff_from_min", "sgtee", "sgp", "sgapp", "sgatg_rank", "Starts_HomeShare", "X_Top5", "rating_mean", "rating_median", "Quality", "field", "course_events", "current_top20") # Run 3_EQ70-70.5   
...
run  <-   "3_EQ70-70.5" # CHANGE THE RUN NUMBER
