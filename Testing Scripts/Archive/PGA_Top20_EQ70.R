...
keepLayers <- names(expl)[c(66,75,7,8,15,21,25,26,30,33,49,51,61,63,64)] # Run 3.EQ70.Top20 - Bigboss model settings - Field quality added - Larger split than run 1
keepLayers <- names(expl)[c(66,75,8,15,25,26,30,33,49,51,64)] # Run 4.EQ70.Top20 - Bigboss model settings - Field quality added - Larger split than run 1
...
keepLayers <- c("log_rating", "Top20_Odds", "current_rank", "Top5_rank", "compat2", "compat_rank", 
                "location", "sgapp", "diff_from_min", "location_rank", "course_rank", "Starts_HomeShare",
                "sgtee_rank", "sgatg_rank", "sgp_rank", "rating_mean", "rating_median", "Quality", "field") # Run 7.EQ71.Top20 - Bigboss
keepLayers <- c("log_rating", "Top5_rank", "Top20_Odds", "current_rank", "compat2", "compat_rank", "course_rank",
                "location", "field", "diff_from_min", "location_rank", "sgtee","current_top20", "sgapp") # Run 8.EQ71.Top20 - Bigboss
...
run  <-   "8.EQ71.Top20" # CHANGE THE RUN NUMBER
