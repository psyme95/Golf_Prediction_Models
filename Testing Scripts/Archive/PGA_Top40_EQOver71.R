...
proj.list <- list()
selected_indices <- sample(1:length(pgalist_filtered), 8)
...
# Models
keepLayers <- c("current", "Top20_Odds", "AvPosn_Rank", "diff_from_min", "compat2", "yr3_Tour", "compat_rank", "location_rank", "Starts_HomeShare", "sgatg_rank", "sgp_rank", "sgtee_rank", "sgapp", "Top5_rank") # Run 1_EQ_Over71
keepLayers <- c("current", "Top20_Odds", "AvPosn_Rank", "diff_from_min", "compat2", "yr3_Tour", "compat_rank", "location_rank", "Starts_HomeShare", "sgatg_rank", "sgp_rank", "sgtee_rank", "sgapp", "Top5_rank", "Quality", "rating_mean") # Run 2_EQ_Over71
keepLayers <- c("current", "Top20_Odds", "AvPosn_Rank", "diff_from_min", "compat2", "yr3_Tour", "compat_rank", "location_rank", "Starts_HomeShare", "sgatg_rank", "sgp_rank", "sgtee_rank", "sgapp", "Top5_rank", "Quality", "rating_mean", "X_Top5") # Run 3_EQ_Over71
[1] "Top20_Odds"       "current_rank"     "yr3_Tour"         "compat_rank"      "compat2"          "course_rank"      "location"         "diff_from_min"    "location_rank"   
[10] "sgtee"            "Starts_HomeShare" "sgapp"            "sgatg"            "sgp_rank"         "rating_mean"      "rating_median"    "X_Top5"           "Quality"         
[19] "field" 

yr3_Tour, Top20_Odds, current_rank, compat2, compat_rank, course_rank, diff_from_min, sgtee, Starts_HomeShare, sgp_rank, rating_mean, X_Top5, Quality, field, course_events, current_top20, location_top20, sgt2g_top20, sgatg_top20, sgapp_top20, lastweek, last_year_loc, active_2wks, sgp_top5, location_top5, course_top5 
...
run  <-   "5_EQ_Over71" # CHANGE THE RUN NUMBER
...
dplyr::filter(myBiomodModelEval, run=="RUN1" & metric.eval=="TSS")
