...
df <- df %>%
  ...
  filter(Quality>= 70.5 & Quality<= 71)
...
proj.list <- list()
selected_indices <- sample(1:length(pgalist_filtered), 9)
...
# Models
keepLayers <- c("AvPosn_Rank", "Top20_Odds", "yr3_Tour", "current_rank", "compat_rank", "diff_from_min", "sgp", "sgtee", "sgapp", "course_rank", "X_Top5", "field", "course_events", "sgtee_top20", "sgapp_top20", "location_top20", "sgatg_top20", "course_top20", "active_2wks", "course_top5", "sgp_top5") # Run 1_EQ70.5-71
keepLayers <- c("AvPosn_Rank", "Top20_Odds", "yr3_Tour", "current_rank", "compat2", "compat_rank", "diff_from_min", "sgp", "location", "sgtee", "sgapp", "course_rank", "location_rank", "sgatg", "Starts_HomeShare", "sgt2g_rank") # Run 2_EQ70.5-71
keepLayers <- c("AvPosn_Rank", "Top20_Odds", "yr3_Tour", "current_rank", "compat2", "compat_rank", "diff_from_min", "sgp", "location", "sgtee", "sgapp", "course_rank", "location_rank", "sgatg", "Starts_HomeShare", "sgt2g_rank", "X_Top5") # Run 3_EQ70.5-71
...
run  <-   "3_EQ70.5-71" # CHANGE THE RUN NUMBER
