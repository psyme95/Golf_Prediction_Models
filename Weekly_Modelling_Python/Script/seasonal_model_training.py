...
def fit_meta_model(oof_matrix, y, implied_odds, seed=RANDOM_SEED):
    """
    LogisticRegression on [oof_model1..N, implied_odds].
    Simultaneously learns ensemble weights and calibrates probabilities.
    """
